...
public class WithdrawFinancialTransactionServiceImpl implements IFinancialTransactionService {

    private static final String WITHDRAW_DEFAULT_DESCRIPTION = "Saque efetuado";
